...
1.1.2 修复从 PDF 阅读器返回资料库后，启动恢复逻辑又自动跳回阅读界面的问题。
...
当前稳定版本为 **1.1.2**，桌面版本支持 Linux x86_64。
...
墨读目前面向最新版 Linux 桌面环境及 Chrome/Edge。扫描 PDF 可以阅读、缩放并添加页面注释，但暂不包含 OCR；账户、云同步、在线协作、PDF 内容编辑与 DRM 文档不在 1.1.2 范围内。Windows 桌面版将在后续版本提供。
